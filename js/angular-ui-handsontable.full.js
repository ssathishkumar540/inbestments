        ...
        compile: function compile(tElement, tAttrs) {
            ...
            var parseAutocomplete = function(scope, column, uiDatagrid) {
                ...
                var lhs = match[1],
                    ...
                    lastItems, lastOptionScope, deregister;
...
.directive('datacolumn', function(getHandsontableSettings, getDatacolumnSettings) {
    var directiveDefinitionObject = {
        ...
        compile: function compile(tElement, tAttrs) {
            return function postLink(scope, element, attrs) {
                var i, uiDatagrid = getHandsontableSettings(element.parent()),
    ...
    var directiveDefinitionObject = {
        ...
        compile: function compile() {
            ...
            return function postLink(scope, element) {
                ...
                var isSelected, lastSelectionRow, lastSelectionCol;
...
(function($, window, Handsontable) {
    ...
    Handsontable.Core = function(rootElement, userSettings) {
        var priv, datamap, grid, selection, editproxy, autofill, instance = this,
        ...
        datamap = {
            ...
            createRow: function(index, amount) {
                var row, colCount = instance.countCols(),
    ...
    (function(Handsontable) {
        ...
        function createContextMenu() {
            var instance = this,
                ...
                options = {},
                i, ilen, settings = instance.getSettings();
